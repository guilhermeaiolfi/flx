...
EmberLayoutManager.prototype = {
    ...
    container.register("component-lookup:main", ComponentLookup);
		this._container = app.container = container;
  ...
  _extractOptionsToRender: function(ctx) {
    ...
    return {
      view: current_route.handler.view || default_view_class,
	...
	buildController: function(ctx) {
		...
		var controller = this.createController(controller_class, context);
    controller.set('container', this._container);
    return controller;
	},
